# Regards Croisés sur la CSRD – Le rôle du DSI - Sweep
...
Participez au webinaire "Regards Croisés sur la CSRD – Le rôle du DSI" le 2 juillet 2024, pour découvrir le rôle clé des DSI dans la conformité à la CSRD, avec des interventions de leaders du secteur.
Date
02 juil. 2024
Horaires
09:30
...
04 novembre 2024
Vous êtes-vous déjà interrogé sur le rôle des DSI dans la conformité à la CSRD ?
C’est pour faire le tour de cette question essentielle que Sweep et Axionable organisent le webinaire “Regards Croisés sur la CSRD – Le rôle du DSI”. Un précieux retour d’expérience sera proposé par Mélissa Saint-Fort, directrice RSE du groupe TFI ainsi que Eric Driutti, responsable outils RSE de TF1.
Date et heure: 2 juillet de 11h30 à 12h30
Avec l’application de la CSRD, les grandes entreprises sont à l’œuvre pour préparer leurs reportings : les Directions des Systèmes d’Information, des Finances et de la RSE doivent avancer main dans la main pour gérer toutes les procédures de collecte et de mise en qualité de données.
Gwendal BIHAN, Président d’Axionable et Rachel Delacour, CEO de Sweep discuteront les meilleures approches pour accompagner la mise en conformité avec la nouvelle réglementation extra-financière.
Parmi les questions abordées :
Quelle conduite du changement et comment articuler la gouvernance entre les Directions RSE, Finances et DSI ?
Quels outils et comment optimiser l’utilisation de la donnée et de l’IA pour son projet CSRD ?
Ce webinaire sera animé par Renaud Bettin, VP Climate action chez Sweep.
En vous inscrivant à ce webinaire, vous acceptez que vos informations soient transmises à Sweep et Axionable.
Axionable est un cabinet de conseil à la croisée de la technologie et du développement durable, certifié B Corp, qui accompagne les entreprises du secteur financier, industriel, de l’énergie, de la distribution, des médias et du secteur public dans leur stratégie climatique : à évaluer et à réduire leur empreinte carbone, ainsi qu’à renforcer leur résilience face aux risques liés au changement climatique grâce à une combinaison innovante de services de conseil, d’expertise ESG et d’outils technologiques de pointe, mobilisés avec pragmatisme et techno-lucidité.
Sweep est une plateforme de gestion des données carbone et ESG. Son logiciel, alimenté par l’intelligence artificielle et leader sur le marché, aide les entreprises à identifier et analyser toutes leurs données extra-financières et celles de leur chaîne de valeur, et ce afin de répondre aux exigences croissantes en matière et reporting et d’agir pour atteindre leurs objectifs de développement durable.
Renaud Bettin
...
+10,000
Taille de l'entreprise*
Quelles sont les questions que vous aimeriez voir abordées lors de cette session ?
...
## Links
  ...
  [English](/events/cross-perspectives-on-the-csrd-the-role-of-the-cio/)
  [French](/fr/events/regards-croises-sur-la-csrd-le-role-du-dsi/)
...
## Images
  ...
  ![Rachel Delacour](/_astro/Rachel%20(1)_Z2eQx3s.webp)
  ![](/_astro/Sweep_Logo_Horizontal_Black-1_1Iuo1H.webp)
  ![](/_astro/AXIONABLE-VIGNETTES-HD-13%20(1)-scaled_QBQIc.webp)
  ![Axionable](/_astro/Logo-Axionable-scaled_1FO9Ls.webp)
  ![](/_astro/Melissa%20SAINT%20FORT-14753-TF1%20--scaled_hHsdw.webp)
  ![](/_astro/companylogoGroupeTF1_2cE8Os.svg)
  ![](/_astro/CAB_6301_1HiqBS.webp)
  ![](/_astro/companylogoGroupeTF1_2cE8Os.svg)
