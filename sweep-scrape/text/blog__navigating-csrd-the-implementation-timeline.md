# Navigating CSRD – The Implementation Timeline - Sweep
...
September 15, 2025
CSRD
When are you obligated to start reporting under the CSRD? We explain everything you need to know about the phased implementation of this new directive.
The
Corporate Sustainability Reporting Directive (CSRD)
has heralded a new era in corporate sustainability reporting in the European Union. Officially in effect since January 2023, this landmark directive aims to enhance transparency, encourage sustainability, and bolster corporate responsibility.
Here’s an overview of the CSRD implementation timeline, with the key dates and details for each phase.
...
If your company is impacted in phase one –
book a demo
with our team.
Phase 2: Other large companies (Reporting fiscal year from January 2025)
Phase two, the
CSRD
extends its reach to the next group – large companies, which were not previously subject to the NFDR and meet at least two out of the following three requirements:
More than 250 employees.
More than €50 million EUR in turnover.
More than €25 million EUR in total assets.
...
More than €900,000 in net turnover.
More than €450,000 in total assets.
It's important to note that companies with less than 10 employees or below 2 million EUR were will not be covered by the
CSRD
. SMEs and other small and non-complex institutions will be given until the 1st of January 2028 to opt into the reporting rules, providing a buffer for adjustment.
Plan ahead and take control of your carbon and ESG data –
book a demo
with our team.
Phase 4: Expanding Beyond EU Borders (Reporting fiscal year from January 2028)
Phase four of
CSRD
implementation, which will begin  on January 1, 2028, will mark a significant expansion of the directive's coverage. From this point onwards, CSRD will be applied to companies headquartered outside the EU that met two key requirements:
A net turnover exceeding €40 million in the EU.
At least one subsidiary or branch in the EU.
This phase aims to ensure that global firms operating in the European Union are held to the same CSRD standards as EU-based companies.
The Future of Reporting Standards
The EU Sustainability Reporting Standards (ESRS) are a crucial component of the
CSRD
and are mandatory for companies which fall within its scope. Developed by the European Financial Reporting Advisory Group (EFRAG), these standards, presented in 12 proposed ESRSs, encompass general principles, cross-cutting disclosure requirements, and specific disclosure requirements for 10 critical Environmental, Social, and Governance (ESG) topics.
...
Achieve full compliance in just a few weeks
Avoid risks of non-compliance and penalties
Focus on your core business growth and innovation
Book a demo
Sweep can help
...
## Links
  ...
  [English](/blog/navigating-csrd-the-implementation-timeline/)
  [French](/fr/blog/naviguer-dans-la-csrd-le-calendrier-de-mise-en-oeuvre/)
  [Login](https://app.sweep.net/auth/sign-in)
  [Book a demo](/demo)
  [Home](/)
  [Blog](/blog)
  [Corporate Sustainability Reporting Directive (CSRD)](https://www.sweep.net/csrd)
  [book a demo](https://www.sweep.net/get-in-touch?utm_source=website&utm_medium=library-what-is-emissions-rebaselining-when-should-it-be-done&utm_campaign=getintouch)
  [CSRD](https://www.sweep.net/csrd)
  [CSRD](https://www.sweep.net/csrd)
  [book a demo](https://www.sweep.net/get-in-touch?utm_source=website&utm_medium=library-what-is-emissions-rebaselining-when-should-it-be-done&utm_campaign=getintouch)
  [CSRD](https://www.sweep.net/csrd)
  [CSRD](https://www.sweep.net/csrd)
  ...
  [The Future of Reporting Standards](#the-future-of-reporting-standards)
...
## Images
  ...
  ![](/_astro/Climate%20Essentials%20-Library-%20%E2%80%93%20Navigating%20CSRD%20%E2%80%93%20sweep.net_1KhFHN.webp)
