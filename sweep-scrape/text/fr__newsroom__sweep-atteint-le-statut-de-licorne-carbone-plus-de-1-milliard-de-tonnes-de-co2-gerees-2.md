# Sweep atteint le statut de « licorne carbone » : Plus de 1 milliard de tonnes de CO2 gérées - Sweep
...
Sweep atteint le statut de « licorne carbone » :
Plus de 1 milliard de tonnes de CO2 gérées
Dernière mise à jour
12 janvier 2026
Sweep, la plateforme leader de gestion des données carbone et ESG, franchit une étape historique : nous gérons désormais plus d’1 milliard de tonnes de CO2 (1 GtCO2) sur les Scopes 1, 2 et 3, grâce à un nombre de clients qui ne cesse d’augmenter.
Au-delà du symbole, c’est une avancée majeure pour accélérer l’action climatique mondiale. Pour mettre les choses en perspective, 1,01 GtCO2 représente près de 3% des émissions mondiales annuelles de carbone.
Cela équivaut :
Aux émissions annuelles totales du Japon
À environ 40% de l’empreinte totale de l’Union européenne
À plus de trois fois l’empreinte carbone totale de la France
Grâce à Sweep, des entreprises comme L’Oréal, Thales et Crocs transforment leurs données extra-financières en avantage business et réduisent leur impact climatique.
Sweep
permet à des milliers d’organisations dans le monde de :
Mesurer et piloter
: Centraliser les données de durabilité sur l’ensemble de la chaîne de valeur.
Se conformer
: Respecter facilement les dernières réglementations ESG mondiales.
Réduire et agir
: Identifier les principaux facteurs d’émissions, suivre les progrès et simuler des trajectoires de réduction qui produisent de vrais résultats.
Ce cap prouve qu’avec les bons outils, les défis de durabilité deviennent actionnables. Sweep ne se limite pas à gérer des données : nous permettons aux entreprises de réduire plus d’un milliard de tonnes de CO2 et d’avancer concrètement vers la neutralité carbone. Ce chiffre illustre ce qui devient possible quand on dispose des moyens pour transformer l’ambition climatique en action.
Rachel Delacour, CEO et cofondatrice de Sweep commente:
« Je ne pourrais pas être plus fière. Nous ne nous contentons pas de suivre des données. Nous permettons concrètement la réduction des émissions à grande échelle, en accélérant la transition vers un avenir net zéro, avec le business au cœur de chaque décision. »
...
## Links
  ...
  [Sweep](https://www.sweep.net/fr/platform)
