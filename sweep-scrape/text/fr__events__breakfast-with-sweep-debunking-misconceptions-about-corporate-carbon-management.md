# Breakfast with Sweep: Debunking misconceptions about corporate carbon management - Sweep
...
Join our event on corporate climate action and learn about how to avoid the pitfalls in the transition to a low-carbon economy. While it's true that many large companies have started looking into their carbon footprint, we know that it’s far from an easy task.
Lieu
London
Date
28 juin 2023
...
04 novembre 2024
Join our event on corporate climate action and learn about how to avoid the pitfalls in the transition to a low-carbon economy. While it's true that many large companies have started looking into their carbon footprint, we know that it’s far from an easy task.
To avoid slowing down your progress from intent to climate action you must be cautious about common traps. These include:
The mistaken belief that quick and inexpensive carbon assessments are worthwhile.
The idea that your CSO is the only person responsible for your climate journey.
The conviction that your suppliers will act on their own emissions.
The mistaken belief that ESG regulations and standards such as CSDR and SFDR don’t concern you.
Hear from climate experts who will:
Deep dive into the importance of a robust methodology
Show you how to have effective stakeholder training
Break down why thorough data verification is important to ensure that your company's carbon assessment is accurate and contributes to effective decarbonization
How to navigate the evolving ESG compliance landscape
You’ll have an opportunity to ask questions and speak directly with our experts who can help you find solutions to your company’s climate needs.
Tom Cumberlege
...
## Links
  ...
  [English](/events/breakfast-with-sweep-debunking-misconceptions-about-corporate-carbon-management/)
  [French](/fr/events/breakfast-with-sweep-debunking-misconceptions-about-corporate-carbon-management/)
...
## Images
  ...
  ![Tom Cumberlege](/_astro/Tom%20Cumberlege%20copy-scaled_Z1YVxyp.webp)
  ![Carbon Trust](/_astro/Carbontrustlogo2021_1VjIWC.webp)
  ![Hannah Clevett](/_astro/image3_1IHWDt.webp)
  ![World lof books's logo](/_astro/WoB_LOGO_oltij.webp)
  ![Raphael Güller](/_astro/Raphael_Z19DXKQ.webp)
  ![Sweep's logo](/_astro/Sweep_Logo_Horizontal_Black_Z1yLRoC.webp)
  ![Erasmia Kitou](/_astro/1518012836181_Z2dwKRv.webp)
  ![Westwing](/_astro/Westwing_Logo_03.2021.svg_Z16XPMJ.webp)
