# Du distributeur au fournisseur (Sweep x Casino) - Sweep
...
Nous explorons comment la technologie SaaS révolutionne la distribution pour relever les défis de la décarbonisation de la chaîne de valeur de la vente au détail.
Lieu
Paris
Date
14 mars 2024
...
04 novembre 2024
Venez nombreux à un événement exclusif :
"Du distributeur au fournisseur : la donnée au centre du pilotage carbone du fournisseur au distributeur".
Le temps d’un petit déjeuner,
Sweep et Groupe Casino
vous proposent un échange pour mieux comprendre les enjeux de la décarbonation de l’offre produits, et le rôle des données.
La distribution joue un rôle clé dans la décarbonation de la chaîne de valeur du retail : les produits représentent plus des 2/3 de l’impact carbone d’un distributeur.
Comment piloter les données carbone liées aux produits commercialisés ?
Comment affiner son scope 3 produits ?
Comment appréhender les données fournisseurs ?
Autant de questions qui seront adressés par le panel d’invités.
Renaud Bettin
VP Climate Action & Sales Enablement
Vincent PAPPOLLA
Co-Founder
Sandra Chartoire Rivet
ESG Director
Flora Schmitlin
Responsable RSE Climat et Eau, Groupe Bel
Emplacement
...
## Links
  ...
  [English](/events/from-distributor-to-supplier-sweep-x-casino/)
  [French](/fr/events/du-distributeur-au-fournisseur-sweep-x-casino/)
...
## Images
  ...
  ![Employee at a supermarket](/_astro/Events%20-Events-%20%E2%80%93%20Casino_ZqiDMk.webp)
  ![Renaud Bettin](/_astro/Renaud-e1762272277827_2sgxvs.webp)
  ![Sweep's logo](/_astro/Sweep_Logo_Horizontal_Black_Z1yLRoC.webp)
  ![](/_astro/Vincent_Zkvr3e.webp)
  ![](/_astro/Open%20Climat_ZfMhwQ.webp)
  ![](/_astro/Sandra_FcauI.webp)
  ![](/_astro/LogoFR_maxi-coul-blanc_UmYPn.webp)
  ![](/_astro/Flora-9-Modifier-HD_3btx9.webp)
  ![](/_astro/Logo_Entreprise_Bel_2019.svg_V8aOl.webp)
