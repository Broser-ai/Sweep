# How to write the perfect carbon management RFP - Sweep
...
EVENT
How to write the perfect carbon management RFP
In this webinar our VP of Climate Action, Renaud Betting, will show you how to effectively navigate the process of writing a climate RFP, including the key criteria that you need to consider, a list of the top questions that you should be asking, and the types of answers that you might expect.
Date
Jun 14, 2023
Time
2:00 PM
...
Carbon
Regulations
Writing an effective RFP can be challenging, as it requires careful consideration of your company's unique circumstances and objectives.
In this webinar our VP of Climate Action, Renaud Betting, will show you how to effectively navigate the process of writing a climate RFP, including the key criteria that you need to consider, a list of the top questions that you should be asking, and the types of answers that you might expect.
Join us to turn this challenging task into a walk in the park.
Renaud Bettin
...
## Images
  ...
  ![Renaud Bettin speaking at a conference](/_astro/Climate%20Essentials%20-Library-%20%E2%80%93%20GHG-2%20(1)_26ru2.webp)
