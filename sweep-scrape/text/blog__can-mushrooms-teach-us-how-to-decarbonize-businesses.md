# Can mushrooms teach us how to decarbonize businesses? - Sweep
...
Insights
Blog
Can mushrooms teach us how to decarbonize businesses?
Category
Blog
Last updated
June 04, 2025
Carbon accounting
Davos. The high-altitude, high-flying annual event where corporate and state leaders plan the year ahead. This year, we attended with one simple message: Let’s get shroomy.
Yes, mushrooms. We were in the mountains after all.
Mushrooms are really amazing. They come in all shapes and sizes, with different properties. They’re superfoods. They’re used in medicine (antibiotics are essentially modeled on mushrooms). And they’re used to create
...
Interestingly mushrooms also build
massive networks
underground, physically connecting plants.
...
Network, because a lot of that data actually sits with your partners. Your staff, your suppliers, your investments (the industry calls
this Scope 3 emissions
).
...
## Links
  ...
  [English](/blog/can-mushrooms-teach-us-how-to-decarbonize-businesses/)
  [French](/fr/blog/les-champignons-peuvent-ils-nous-apprendre-a-decarboniser-les-entreprises/)
  [Login](https://app.sweep.net/auth/sign-in)
  [Book a demo](/demo)
  [Home](/)
  [Blog](/blog)
  [new sustainable building materials](https://www.mycosuisse.ch/)
  [massive networks](https://www.weforum.org/agenda/2022/07/fungi-forests-carbon-climate/)
  [this Scope 3 emissions](https://www.sweep.net/blog/what-are-scope-3-emissions-how-should-you-measure-them)
  [See how it works](https://www.sweep.net/get-in-touch)
  [Book a demo](https://www.sweep.net/demo?utm_medium=content)
  [But what have mushrooms got to do with carbon?](#but-what-have-mushrooms-got-to-do-with-carbon)
  [Carbon is both a data and a network problem](#carbon-is-both-a-data-and-a-network-problem)
  [The data network in action](#the-data-network-in-action)
  [From small actions to a network of change](#from-small-actions-to-a-network-of-change)
...
## Images
  ...
  ![](/_astro/bryony-elena-cD1fvHEdwwI-unsplash-scaled_195ijL.webp)
