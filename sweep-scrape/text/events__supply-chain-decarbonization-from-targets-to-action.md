# Supply chain decarbonization: From targets to action - Sweep


**Description:** Watch the on-demand webinar to learn how to turn supply chain decarbonization commitments into measurable action—fast.
...
Watch the on-demand webinar to learn how to turn supply chain decarbonization commitments into measurable action—quickly and at scale.
Location
Online
Date
Mar 03, 2026
...
Partner
Supply Chain
The climate targets are set. The roadmaps are drawn. Yet when it comes to supply chain decarbonization, many companies are still struggling to move from plans to measurable progress.
The barrier isn’t ambition—it’s execution.
How do you translate climate commitments into action across complex, global supply chains?
Watch our on-demand webinar with
Capgemini Invent and Sweep
to explore how to close this gap. You’ll learn the
practical steps
,
proven principles
, and
critical success factors
to operationalize supply chain decarbonization at scale—so you can move from reporting to real steering.
We cover:
Why
transparency
is the foundation of supply chain decarbonization
How emissions data can be anchored in
governance
and
decision-making
The
role of digital tools
like Sweep in enabling efficient measurement and steering
Tanja Fischer
Manager Decarbonization & Sustainable Procurement
Felicity Box
Solutions Engineer
More events
PAST EVENT
...
## Images
  ...
  ![](/_astro/SpeakerphotoTanjaFischer-scaled_rIJH8.webp)
  ![Capgemini's logo](/_astro/Capgemini_Z1UnF8o.webp)
