# Sweep is live in the new Stripe App Marketplace! - Sweep
...
September 24, 2024
News announcement
Understand the emissions of everything you sell.
At Sweep, we believe data is one of the most effective ways to drive change in behaviors. That’s why we’ve teamed up with Stripe to launch an app that calculates the emissions of everything you sell on this platform.
Available in the new Stripe App Marketplace, it combines Stripe’s transaction data with Sweep’s emission factor database. Within seconds, you can understand the climate impact of your sales, see how much they feed into your company’s carbon footprint, and plan your reduction roadmap accordingly.
As a strong advocate for carbon transparency, we’re proud to be
one of the first apps
selected to support the millions of Stripe’s businesses – by helping them take the first step to map emissions and
meet climate targets
. The Sweep for Stripe app lets you:
👀
See your climate impact without leaving Stripe:
Access carbon and transaction data all in one place.
💸
Calculate the emissions of your financial activities:
Quickly and easily understand the footprint of your sales.
📉
Add new data to your invoices or copy it to your clipboard:
Use the calculations to inform your customers and your reduction roadmap.
Get started with the
Sweep app for Stripe
today.
Sweep can help
...
## Links
  ...
  [English](/newsroom/sweep-is-live-in-the-new-stripe-app-marketplace/)
  [French](/fr/newsroom/sweep-est-en-ligne-sur-le-nouveau-stripe-app-marketplace/)
  [Login](https://app.sweep.net/auth/sign-in)
  [Book a demo](/demo)
  [one of the first apps](https://www.businesswire.com/news/home/20220524005346/en/Sweep-Launches-Climate-Impact-App-in-New-Stripe-App-Marketplace)
  [meet climate targets](https://www.sweep.net/book-a-demo/)
  [Sweep app for Stripe](https://marketplace.stripe.com/apps/sweep)
