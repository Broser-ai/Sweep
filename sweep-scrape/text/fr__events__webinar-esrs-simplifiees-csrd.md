# 30 minutes pour comprendre les ESRS simplifiées avec Patrick de Cambourg - Sweep


**Description:** Webinar CSRD le 26 mars 2026 à 11h30 avec Patrick de Cambourg et Julien Denormandie, pour comprendre les ESRS simplifiées, leurs implications stratégiques et les actions à mettre en place dès maintenant.
...
EVENT
30 minutes pour comprendre les ESRS simplifiées avec Patrick de Cambourg
Participez à notre masterclass avec l’un des principaux artisans des normes ESRS : Patrick de Cambourg.
Accédez à la masterclass
Accédez à la masterclass
Dernière mise à jour
13 avril 2026
Les normes ESRS ont récemment été simplifiées par l’EFRAG, réduisant le nombre data points obligatoires pour la CSRD de 61%.
Comment les appliquer dès aujourd’hui pour votre reporting CSRD ?
Patrick de Cambourg,
ancien président du Sustainability Reporting Board de l’EFRAG et l’un des principaux artisans des normes ESRS et de la CSRD,
décrypte les nouveaux mécanismes d’allègement, et partage ses conseils pour les mettre en place.
Il est accompagné de Julien Denormandie, Chief Impact Officer chez Sweep et ancien ministre.
Vous allez apprendre à :
1️⃣ Maîtriser les ESRS simplifiées et leurs principales nouveautés
2️⃣ Alléger votre conformité avec les nouveaux mécanismes d’allègement
3️⃣ Construire votre feuille de route CSRD selon votre niveau de maturité
Accéder à la vidéo👇
Plus d'événements
ÉVÉNEMENT PASSÉ
juin
...
## Images
  ...
  ![ESRS webinar](/_astro/LPheader1_20kKVK.webp)
