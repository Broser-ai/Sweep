# Your guide to CSRD compliance - Sweep


**Description:** Prepare for CSRD: Learn key objectives, data collection, audit needs, and how it impacts UK businesses. Get expert guidance for a smooth transition with Sweep.
...
Book a demo
Guide to CSRD Compliance
Download
Contents
In this guide you will learn:
Companies affected by the CSRD
CSRD Requirements
How does the CSRD relate to other regulations?
...
## Links
  ...
  [English](/guides/your-guide-to-csrd-compliance-2/)
  [French](/fr/guides/votre-guide-pour-assurer-la-conformite-avec-la-csrd1/)
  [Login](https://app.sweep.net/auth/sign-in)
  [Book a demo](/demo)
  [Home](/)
  [Guides](/guides)
  [Book a demo](https://www.sweep.net/demo?utm_medium=content)
  [Download](/pdf/sweep_guide_csrd_v71-11646.pdf)
  [In this guide you will learn:](#in-this-guide-you-will-learn)
  [Companies affected by the CSRD](#companies-affected-by-the-csrd)
  [CSRD Requirements](#csrd-requirements)
  [How does the CSRD relate to other regulations?](#how-does-the-csrd-relate-to-other-regulations)
...
## Images
  ...
  ![](/_astro/Guide%20-Library-%20%E2%80%93%20CSRD_a2nBw.webp)
  ![Comparison.png](/_astro/Comparison_Z1ll1aR.webp)
  ![](/_astro/End%20of%20Part%203-2-1140x610_21HugR.webp)
  ![CSRD-s_links.png](/_astro/CSRD-s_links_1yIHg4.webp)
  ![](/_astro/End%20of%20Part%207-1140x610_23ImhW.webp)
