# Benchmark du MEDEF: Sweep seule solution CSRD à cocher toutes les cases - Sweep
...
Benchmark du MEDEF: Sweep seule solution à cocher toutes les cases
Dernière mise à jour
02 mai 2025
Sweep est la seule plateforme CSRD qui obtient
la note maximale dans toutes les catégories
du benchmark mené par le MEDEF et Colombus Consulting.
3 domaines ont été évalués :
L’analyse de double matérialité,
La collecte et le traitement de la data,
La production d’un rapport CSRD conforme.
Parmi les 13 outils inclus dans l’étude, Sweep est le seul à obtenir la note maximale sur l’ensemble des 18 critères évalués.
Source:
Etude de marché MEDEF des éditeurs et progiciels destinés à produire un rapport de durabilité répondant aux exigences de la CSRD
L’Oréal, Bouygues, Lacoste, TF1 et le Crédit Agricole utilisent déjà Sweep pour :
Réaliser leur analyse de double matérialité
Collecter et consolider leur data ESG et celle de leurs fournisseurs
Produire facilement leur rapport CSRD
Mais aussi pour se fixer des objectifs ambitieux en créant des scénarios de réductions d’émissions sur plusieurs années.
Vérifiez par vous même si Sweep correspond à vos enjeux CSRD avec une démo personnalisée !
Prénom
*
Nom
*
...
## Links
  ...
  [Etude de marché MEDEF des éditeurs et progiciels destinés à produire un rapport de durabilité répondant aux exigences de la CSRD](https://www.medef.com/uploads/media/default/0020/04/16130-etude-de-marche-des-editeurs-et-progiciels-destines-a-produire-un-rapport-de-durabilite-repondant-aux-exigences-de-la-csrd-2024.pdf)
...
## Images
  ...
  ![](/_astro/image18_Z29NdsH.webp)
  ![](/_astro/Frame9587_f4y9S.webp)
